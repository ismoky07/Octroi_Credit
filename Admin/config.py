...
DOSSIER_DEMANDES = "demandes_clients"
DOSSIER_AUTO = f"{DOSSIER_DEMANDES}/auto"
DOSSIER_IMMO = f"{DOSSIER_DEMANDES}/immo"
DOSSIER_CONSO = f"{DOSSIER_DEMANDES}/conso"
DOSSIER_DECOUVERT = f"{DOSSIER_DEMANDES}/decouvert"
