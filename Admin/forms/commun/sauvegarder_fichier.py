"""
Module pour sauvegarder les fichiers téléversés via l'application de crédit
Ce module contient les fonctions nécessaires pour enregistrer correctement les fichiers 
téléversés par les clients via l'application Streamlit
"""
