"""
admin/gestion_credits.py - Gestion des demandes de crédit avec traitement OCR intégré
VERSION ALTERNATIVE : Structure sans expanders imbriqués
"""
...
from traitement_documents import afficher_section_documents

def afficher_gestion_credit(titre: str, demandes: List[Dict], type_credit: str):
    """
    Affiche la gestion des demandes pour un type de crédit spécifique avec traitement OCR
    ...
    if demandes_filtrees:
        ...
        for i, demande in enumerate(demandes_filtrees):
            # Version alternative : Utiliser des colonnes au lieu d'expanders imbriqués
...
def afficher_demande_avec_colonnes(demande: Dict, type_credit: str, index: int):
    """
    Affiche une demande avec une structure en colonnes (sans expanders imbriqués)
    ...
    with st.container():
        ...
        # Section 2: Documents (expander séparé, pas imbriqué)
