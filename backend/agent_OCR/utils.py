"""
backend/agent_OCR/utils.py - Utilitaires pour le module OCR
"""
import os
import sys
import io

# Configuration de l'encodage pour eviter les problemes
try:
...
def safe_text_handling(text):
    """Assure que le texte est correctement encode en UTF-8"""
    if text is None:
        return ""
